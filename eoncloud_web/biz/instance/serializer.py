...
class InstanceSerializer(serializers.ModelSerializer):
    ...
    image_info = ImageSerializer(source="image", required=False, allow_null=True, default=None, read_only=True)
    floating_info = serializers.CharField(source="floating_ip", required=False, allow_null=True, default=None, read_only=True)
    create_date = serializers.DateTimeField(format="%Y-%m-%d %H:%M", required=False, allow_null=True)
    terminate_date = serializers.DateTimeField(format="%Y-%m-%d %H:%M", required=False, allow_null=True)
