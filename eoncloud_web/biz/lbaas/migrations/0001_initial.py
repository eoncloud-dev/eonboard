    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('protocol_port', models.CharField(max_length=10, null=True, verbose_name='protocol_port', blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(serialize=False, primary_key=True)),
                ('monitor_uuid', models.CharField(max_length=40, verbose_name='monitor_uuid', blank=True)),
                ...
                ('max_retries', models.IntegerField(verbose_name='max_retries')),
                ('http_method', models.CharField(default=b'POST', max_length=10, null=True, verbose_name='http_method', blank=True)),
                ('url_path', models.CharField(default=b'/', max_length=10, null=True, verbose_name='url_path', blank=True)),
                ('expected_codes', models.CharField(default=b'200', max_length=128, null=True, verbose_name='expected_codes', blank=True)),
                ('admin_state_up', models.BooleanField(default=True, verbose_name='admin state up', choices=[(True, b'UP'), (False, b'DOWN')])),
                ('create_date', models.DateTimeField(auto_now_add=True, verbose_name='Create Date')),
                ('deleted', models.BooleanField(default=False, verbose_name='Deleted')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lb_method', models.IntegerField(verbose_name='lb_method', choices=[(0, b'ROUND_ROBIN'), (1, b'LEAST_CONNECTIONS'), (2, b'SOURCE_IP')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('protocol', models.IntegerField(verbose_name='protocol', choices=[(0, b'TCP'), (1, b'HTTP'), (2, b'HTTPS')])),
                ('protocol_port', models.CharField(max_length=10, null=True, verbose_name='protocol_port', blank=True)),
                ('port_id', models.CharField(max_length=40, null=True, verbose_name='port_id', blank=True)),
                ('session_persistence', models.IntegerField(blank=True, null=True, verbose_name='session_persistence', choices=[(0, b'SOURCE_IP'), (1, b'HTTP_COOKIE'), (2, b'APP_COOKIE')])),
                ('connection_limit', models.IntegerField(default=-1, verbose_name='connection_limit')),
                ('admin_state_up', models.BooleanField(default=True, verbose_name='admin state up', choices=[(True, b'UP'), (False, b'DOWN')])),
                ('status', models.IntegerField(default=0, verbose_name='Status', choices=[(0, 'CREATING'), (1, 'ACTIVE'), (2, 'CREATED'), (3, 'DOWN'), (4, 'ERROR'), (5, 'INACTIVE'), (6, 'UPDATING'), (7, 'DELETING')])),
                ('create_date', models.DateTimeField(auto_now_add=True, verbose_name='Create Date')),
                ('deleted', models.BooleanField(default=False, verbose_name='Deleted')),
