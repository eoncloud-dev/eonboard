...
CloudApp.controller('RouterController',
    function ($rootScope, $scope, $filter, $timeout, $interval, $i18next, $modal,
              ngTableParams, Router, status_desc, CommonHttpService, ToastrService) {
